<form
  action=""
  class=" flex h-96  w-1/2 flex-col items-center space-y-6 bg-white "
>
  <div class=" mt-6">Регистрация</div>
  <div class="isolate w-3/4 -space-y-px rounded-md shadow-sm">
    <div
    ...
    >
      <label for="username" class="block text-xs font-medium text-gray-900"
        >Придумайте имя пользователя</label
      >
      <input
        type="text"
        name="username"
    ...
    <div
      class="relative  rounded-t-none border  border-gray-300 px-3 py-2 focus-within:z-10 focus-within:border-indigo-600 focus-within:ring-1 focus-within:ring-indigo-600"
    >

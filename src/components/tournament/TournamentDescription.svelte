...
<div class="overflow-hidden bg-white shadow sm:rounded-lg border">
    <div class="px-4 py-5 sm:px-6 flex justify-between items-center">
      ...
      <span class="isolate inline-flex rounded-md shadow-sm shadow-slate-800 bg-white hover:bg-gray-50 ">
    ...
    <div class="border-t border-gray-200">
      <dl>
        <div class="bg-gray-50 px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
          ...
          <dd class="mt-1 text-sm text-gray-900 sm:col-span-2 sm:mt-0">Самый лучший турнир</dd>
        </div>
        <div class="bg-white px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
          <dt class="text-sm font-medium text-gray-500">Контроль</dt>
          <dd class="mt-1 text-sm text-gray-900 sm:col-span-2 sm:mt-0">
            <Badge title="3+0" color={{text:"text-slate-700 px-2", bg:"bg-slate-100"}}/>
          </dd>
        </div>
        <div class="bg-gray-50 px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
          <dt class="text-sm font-medium text-gray-500">Формат</dt>
          <dd class="mt-1 text-sm text-gray-900 sm:col-span-2 sm:mt-0">
            <Badge title="Щвейцарская система" color={{text:"text-green-800 px-2 py-1", bg:"bg-green-200"}}/>
          </dd>
        </div>
        <div class="bg-white px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
          <dt class="text-sm font-medium text-gray-500">Дата начала</dt>
          <dd class="mt-1 text-sm text-gray-900 sm:col-span-2 sm:mt-0">12 ноября, 12:00 (через 3 часа)</dd>
        </div>
        <div class="bg-gray-50 px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">

...
<div class="   relative  flex      ">
  ...
  <div
    ...
    class=" group relative flex flex-1 items-start space-x-3 rounded-tr-md   bg-white p-2  hover:bg-slate-100"
  >
    <div class="flex-shrink-0">
      <span class=" inline-flex h-10 w-10 items-center justify-center rounded-lg bg-green-200">

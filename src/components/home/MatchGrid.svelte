<script lang="ts">
  ...
  function createMatch({ control, filters, rounds }: { control: string; filters: MatchFilters; rounds: number }) {
...
<div class=" grid grid-cols-3 gap-2">
  {#each controls as control}
    ...
    <div
      ...
      class=" relative flex aspect-square cursor-pointer items-center justify-center rounded-lg {$currentMatchControl == control
        ? ' bg-slate-900'

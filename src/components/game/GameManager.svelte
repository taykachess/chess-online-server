    ...
    {#if onlyPlayers}
      {#if isPossibleAcceptDraw}
        <div class=" flex flex-col">
          ...
          <div class=" grid grid-cols-2">
            ...
            <div
              on:click={acceptDraw}
              class="flex cursor-pointer justify-center border-x border-b border-slate-800 bg-green-100 hover:bg-green-200 hover:text-green-600"
            >
              <!-- prettier-ignore -->
              <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
      ...
      <div
        ...
        class=" {countClick == 1
          ...
          : 'hover:bg-pink-200 hover:text-pink-600'} flex cursor-pointer items-center justify-center  space-x-2 border border-slate-800 "
      >

...
export const loginSchema = z.object({
  username: z.string({ required_error: 'Name is required' }).min(5, { message: 'Name must be at least 5 length' }).max(64, { message: 'Name must be less than 64 characters' }).trim(),
